...
@Component({
	selector: "app-login-form3",
	templateUrl: "./login-form3.component.html",
	styleUrls: ["./login-form3.component.scss"],
})
export class LoginForm3Component implements OnInit, OnDestroy {
